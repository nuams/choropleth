...
(function($, my) {
  ...
  my.ChoroplethMap = Backbone.View.extend({
    ...
    initialize: function(options) {
      ...
      this.label_to_map = options.label_to_map ? options.label_to_map.toLowerCase() : 'state';
      ...
      this.menu = new MenuClass({
        ...
        label_to_map: this.label_to_map,
      });
    ...
    _filteredRecordsForPoly: function(poly_name) {
      ...
      var label_index = self.fields_map.indexOf(self.label_to_map);
      var field_index = self.fields_map.indexOf(state['columnToDisplay']);
